...
\tab \tab In the later case, pick an element $g$ other than the identity. It has some order, $m>1$. Either $p_i \mid m$ or not. If so, then take $g^{m/p_i}$; this element clearly has order $p_i$. If not, then %Mod out, rewrite this to act like an inductive proof.
