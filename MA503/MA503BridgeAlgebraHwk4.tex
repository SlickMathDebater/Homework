...
\tab %Proof: Use the group action to homomorph H into S_p. let h be such an element. h has order p. so h must be a p-cycle, because p is prime.
...
The adaptation is this: %ctrl c ctrl v
