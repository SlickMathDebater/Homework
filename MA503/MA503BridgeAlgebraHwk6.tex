...
\tab Last, each element has an inverse: let $a \in R \setminus \{0_R\}$. Then...%something
...
Second, $\phi$ is injective: let $I_1,I_2$ be $R$-ideals, and $J=\phi(I_1)=\phi(I_2)$. For each $i \in I_1$, the matrix $blah \in J$. This implies that for each $i \in I_1$, $i \in I_2$. Similarly, for each $i \in I_2$ we have that $i \in \I_1$. So $I_1 = I_2$. %blah is the matrix i in one entry, zeroes in the rest.

Last, $\phi$ is surjective: let $J$ be an $S$-ideal. %This is the one I don't know how to do.
