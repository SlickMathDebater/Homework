...
\tab Consider $R_r = S^{-1}R$, where $S = \{r^n: n \geq 0\}$. Let $x \in R_r$. Then %x=0 for some reason.

\tab So $R_

\tab If $r \in \bigcap\limits_{P \in Spec(R)} P$, then consider the set $S = \{x^n: n \in \N\}$, and consider $S^{-1}R = R_x$.
