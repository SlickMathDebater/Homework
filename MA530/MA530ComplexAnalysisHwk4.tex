...
\tab Let $r<1$. Then for each $k \in \N$, $\frac{z^k}{1-z^k} < blah = M_n$. Now, $\sum M_n$ converges. So $\sum\limits_{k=1}^\infty \frac{z^k}{1-z^k}$ converges uniformly on $D_r(0)$ by the Weierstrauss M-test.  %Find blah.
