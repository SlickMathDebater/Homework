...
Now, $f 1/f = 1 = \sum\limits_{-\infty}^\infty a_n z^n \sum\limits_{-\infty}^\infty b_n z^n$. So...%That's somewhat clearly the schtick...Some linear algebra can be done on this...
