...
\end{align*} %This is somehow the wrong way to do this...
...
%From earlier work, we have


%\begin{align*}
%&= \frac{1}{2\pi i} \sum\limits_{n=0}^\infty \int\limits_{ \partial D_r(0)} %\frac{na_nz^{n-1}}{z\sum\limits_{m=0}^\infty a_{m}z^{m-1}} dz\\
%\end{align*} %This will come in handy, but I'm not sure exactly where.

%Your sense is that it's the argument principle result plus k somehow...
