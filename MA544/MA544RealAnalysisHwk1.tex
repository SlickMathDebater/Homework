...
\tab Then all subsequences of $\anbrack{x_n}$ converge to $L$. So the infimum and the supremum of the set of limit points of $\anbrack{x_n}$ are both $L$ (the infimum and supremum of $\{L\}$ is $L$). So $\limsup(x_n) = \liminf(x_n) = L$.%Then both limsup and liminf = L. This is because all subsequences of x_n converge to L.
